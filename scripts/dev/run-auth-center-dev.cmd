...
>> "%BACKEND_LOG_FILE%" echo [%DATE% %TIME%] START mvnw.cmd -Dmaven.repo.local=.m2/repository -f auth-center/pom.xml -DskipTests spring-boot:run
set "BACKEND_SERVICE_COMMAND=mvnw.cmd -Dmaven.repo.local=.m2/repository -f auth-center/pom.xml -DskipTests spring-boot:run"
