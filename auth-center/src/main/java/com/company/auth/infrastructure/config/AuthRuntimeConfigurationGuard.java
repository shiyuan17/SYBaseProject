...
@Component
public class AuthRuntimeConfigurationGuard {

    private final Environment environment;
    private final SecurityJwtProperties securityJwtProperties;
    private final DataSourceProperties dataSourceProperties;

    public AuthRuntimeConfigurationGuard(Environment environment,
    ...
    void validate() {
        ...
        if (!environment.acceptsProfiles(Profiles.of("test", "local"))) {
            requireText(dataSourceProperties.getUrl(), "Missing required datasource URL: AUTH_CENTER_DATASOURCE_URL");
            requireText(dataSourceProperties.getUsername(), "Missing required datasource username: AUTH_CENTER_DATASOURCE_USERNAME");
            requireText(dataSourceProperties.getPassword(), "Missing required datasource password: AUTH_CENTER_DATASOURCE_PASSWORD");
        }
    }
