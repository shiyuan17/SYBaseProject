...
class SpecimenReceiptLogisticsStaffNameV73MigrationTest {

    @Test
    void shouldRepairReceiptLogisticsStaffNameColumnWhenLegacySchemaIsBaselinedPastV72() throws Exception {
        String url = "jdbc:h2:mem:legacy_m2_receipt_logistics_v73_" + System.nanoTime() + ";MODE=LEGACY;DB_CLOSE_DELAY=-1;DATABASE_TO_UPPER=false";
        ...
        try (Connection connection = DriverManager.getConnection(url, "sa", "");
            ...
            assertEquals(0, queryInt(statement, """
                ...
                WHERE LOWER(TABLE_NAME) = 'specimen_receipts'
                  AND LOWER(COLUMN_NAME) = 'logistics_staff_name'
                """));
        ...
        Flyway.configure()
            ...
            .baselineVersion(MigrationVersion.fromVersion("72"))
            .baselineDescription("legacy-m2-receipt-logistics-v73")
            .load()
            .migrate();
