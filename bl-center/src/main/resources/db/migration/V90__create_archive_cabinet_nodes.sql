CREATE TABLE archive_cabinet_nodes (
...
CREATE INDEX idx_archive_cabinet_nodes_parent ON archive_cabinet_nodes (parent_id);
CREATE INDEX idx_archive_cabinet_nodes_cabinet ON archive_cabinet_nodes (cabinet_id);
