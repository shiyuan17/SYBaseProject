...
public final class M4PermissionCodes {

    public static final String DIAG_TASK_QUERY = "PERM_M4_DIAG_TASK_QUERY";
    public static final String ASSIGN = "PERM_M4_ASSIGN";
    public static final String ACCEPT = "PERM_M4_ACCEPT";
    public static final String START = "PERM_M4_START";
    public static final String WORKBENCH_QUERY = "PERM_M4_WORKBENCH_QUERY";
    public static final String REPORT_CREATE = "PERM_M4_REPORT_CREATE";
    public static final String REPORT_SUBMIT = "PERM_M4_REPORT_SUBMIT";
    public static final String REPORT_REVIEW = "PERM_M4_REPORT_REVIEW";
