...
@Getter
@Setter
@Schema(name = "CreatePathologyReportRequest", description = "创建病理报告草稿请求")
@RejectLegacyOperatorFields
public class CreatePathologyReportRequest {
    ...
    @Schema(description = "诊断任务 ID", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotBlank
    @Size(max = 64)
