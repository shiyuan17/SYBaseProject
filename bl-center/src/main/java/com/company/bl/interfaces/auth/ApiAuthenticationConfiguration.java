...
public class ApiAuthenticationConfiguration {
    ...
    @Bean
    public TokenSessionValidator tokenSessionValidator(TokenSessionJdbcRepository tokenSessionJdbcRepository) {
        return tokenSessionJdbcRepository::isAccessTokenActive;
    }
