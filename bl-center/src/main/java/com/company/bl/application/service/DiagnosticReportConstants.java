...
final class DiagnosticReportConstants {
    ...
    static final String TASK_ACCEPTED = "ACCEPTED";
    ...
    static final String REPORT_REVIEWED = "REVIEWED";
    static final String REPORT_SIGNED = "SIGNED";
    static final String REPORT_PUBLISHED = "PUBLISHED";
    static final String REVISION_PENDING = "PENDING";
    static final String REVISION_APPROVED = "APPROVED";
    static final String REVISION_REJECTED = "REJECTED";
    static final String ORDER_SCOPE_TECHNICAL = "TECHNICAL";
    static final String ORDER_BILLING_PENDING = "PENDING";
    static final String ORDER_PENDING = "PENDING";
    ...
    static final String CONSULTATION_COMPLETED = "COMPLETED";
    static final String PARTICIPANT_HOST = "HOST";
    static final String PARTICIPANT_EXPERT = "EXPERT";
    static final String PARTICIPANT_RECORDER = "RECORDER";

    private DiagnosticReportConstants() {
    }
}
